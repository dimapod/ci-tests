...
module.exports = function (app, mongoose) {
    ...
    app.get(URL_PREFIX + '/systems', function (req, res) {
        var rez = [
    ...
    app.get(URL_PREFIX + '/cats', function (req, res) {
    ...
    app.post(URL_PREFIX + '/cats', function (req, res) {
    ...
    app.post(URL_PREFIX + '/reinit', function (req, res) {
